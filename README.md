...
2.Low performance and big boundingbox, probably cause by multiple factors.  
3.Current adapter's initial alpha is 0.9  
4.Bruteforce method to generate heatmap from bounding box.  
