...
from utils.zsg_data import FlickrDataset, VGDataset, GOT
...
if parser_args.model == 'vit14':
    ...
    elif parser_args.dataset.startwith('GOT'):
        args = {
            'model': 'vit14',
            'alpha': 0.75,
            'aggregation': 'mean',
...
if parser_args.dataset == 'flickr_original':
    ...
    dataset = VGDataset(data_type='val_balanced')
elif parser_args.dataset == 'GOT':
    dataset = GOT(data_type='val/GOT-10k_Val_000001')
else:
    assert False
